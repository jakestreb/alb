...
from casestudy.views import LoginView, SecurityView, SecurityPriceView, WatchlistView
...
urlpatterns = [
    ...
    path('securities/prices/', SecurityPriceView.as_view(), name='security_price'),
